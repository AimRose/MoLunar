...
import at.aimrose.molunar.utils.ItemBuilder;
...
public class MenuCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        menuinv.setItem(10, new ItemBuilder(Material.NAME_TAG).setDisplayname("§eDeine UUID").setLore("§7" + p.getUniqueId().toString()).build());
        ...
        menuinv.setItem(13, new ItemBuilder(Material.DRAGON_EGG).setDisplayname("§eDein Account").setLore("§7" + p.getDisplayName()).build());
        ...
        menuinv.setItem(16, new ItemBuilder(Material.REDSTONE_COMPARATOR).setDisplayname("§eDeine Adresse").setLore("§7" + p.getAddress().toString()).build());
        ...
        menuinv.setItem(20, new ItemBuilder(Material.STAINED_GLASS_PANE).setDisplayname(" ").build());
        menuinv.setItem(21, new ItemBuilder(Material.STAINED_GLASS_PANE).setDisplayname(" ").build());
        menuinv.setItem(22, new ItemBuilder(Material.STAINED_GLASS_PANE).setDisplayname(" ").build());
        menuinv.setItem(23, new ItemBuilder(Material.STAINED_GLASS_PANE).setDisplayname(" ").build());
        menuinv.setItem(24, new ItemBuilder(Material.STAINED_GLASS_PANE).setDisplayname(" ").build());
        ...
        menuinv.setItem(28, new ItemBuilder(Material.SPECTRAL_ARROW).setDisplayname("§eTeamspeak").build());
        ...
        menuinv.setItem(31, new ItemBuilder(Material.REDSTONE_TORCH_ON).setDisplayname("§eDiscord").build());
        ...
        menuinv.setItem(34, new ItemBuilder(Material.COMMAND).setDisplayname("§ePlugin Version").setLore("§7Beta-Version").build());
